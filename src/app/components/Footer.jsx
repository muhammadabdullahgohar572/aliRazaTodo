...
const Footer = () => {
  return (
    <footer className="bg-yellow-50 text-white py-10">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Brand Info */}
        <div className="flex flex-col items-center md:items-start">
          <h2 className="text-2xl font-bold text-blue-500 mb-4">Your Brand</h2>
          <p className="text-gray-400 text-center md:text-left">
            Transforming ideas into reality. Your trusted tech partner.
          </p>
        </div>
        {/* Quick Links */}
        <div className="flex flex-col items-center">
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li>
              <a href="/show-task" className="hover:text-blue-400">
                Show Task
              </a>
            </li>
            <li>
              <a href="/add-task" className="hover:text-blue-400">
                Add Task
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/sign-up" className="hover:text-blue-400">
                Sign Up
              </a>
            </li>
          </ul>
